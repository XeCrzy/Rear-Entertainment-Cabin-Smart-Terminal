...
public:
    ...
    void setupUi(QWidget *easyInput)
    {
        ...
        easyInput->setStyleSheet(QString::fromUtf8("border-image: url(:/image/background.png);"));
        ...
        widgetMain->setStyleSheet(QString::fromUtf8("color: rgb(255, 255, 255);\n"
...
"}"));
    ...
    void retranslateUi(QWidget *easyInput)
    {
        ...
        easyInput->setWhatsThis(QCoreApplication::translate("easyInput", "<html><head/><body><p><br/></p></body></html>", nullptr));
