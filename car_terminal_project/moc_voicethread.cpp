...
QT_MOC_LITERAL(1, 12, 12), // "voiceCommand"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 7), // "command"
QT_MOC_LITERAL(4, 34, 13), // "statusChanged"
QT_MOC_LITERAL(5, 48, 6), // "status"
QT_MOC_LITERAL(6, 55, 22) // "voiceRecordingFinished"

    },
    "VoiceThread\0voiceCommand\0\0command\0"
    "statusChanged\0status\0voiceRecordingFinished"
};
...
void VoiceThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->voiceCommand((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->statusChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->voiceRecordingFinished(); break;
        default: ;
        }
        ...
        {
            typedef void (VoiceThread::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VoiceThread::voiceCommand)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (VoiceThread::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VoiceThread::statusChanged)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VoiceThread::voiceRecordingFinished)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject VoiceThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_VoiceThread.data,
      qt_meta_data_VoiceThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void VoiceThread::voiceCommand(const QString & _t1)
{
...
// SIGNAL 1
void VoiceThread::statusChanged(const QString & _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void VoiceThread::voiceRecordingFinished()
{
