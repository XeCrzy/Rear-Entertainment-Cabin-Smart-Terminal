...
public:
    ...
    void setupUi(QWidget *easyInput)
    {
        ...
        widgetTop->setStyleSheet(QStringLiteral(""));
        ...
        widgetMain->setStyleSheet(QLatin1String("color: rgb(255, 255, 255);\n"
...
"}"));
    ...
    void retranslateUi(QWidget *easyInput)
    {
        ...
        easyInput->setWhatsThis(QApplication::translate("easyInput", "<html><head/><body><p><br/></p></body></html>", 0));
